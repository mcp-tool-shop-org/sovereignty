...
v2.2.1 में पहले से निर्मित बाइनरी [GitHub रिलीज़ पृष्ठ](https://github.com/mcp-tool-shop-org/sovereignty/releases/latest) पर उपलब्ध हैं:
...
- **लिनक्स (x64, .deb):** `sovereignty-app-2.2.1-linux-x64.deb` — डेबियन / उबंटू / व्युत्पन्न। `sudo dpkg -i sovereignty-app-2.2.1-linux-x64.deb` के साथ स्थापित करें। ऐपइमेज सपोर्ट संस्करण 2.2 में उपलब्ध होगा (अपस्ट्रीम `linuxdeploy` / उबंटू 24.04 FUSE इंटरैक्शन)।
