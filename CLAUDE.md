...
- **Release pipeline**: `.github/workflows/release.yml` ships PyPI + PyInstaller binaries (3 platforms) + npm-launcher. PyPI publish gates on `needs: [build-binaries]` (Stage B fix — fail-closed).
