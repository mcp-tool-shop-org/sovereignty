...
Health A amend from `swarm-1787866749-d85e` waves 2 and 4. Do not retag `v2.3.0`; next publish is `2.3.1` after this swarm lands and CI is green.
...
- Engine RNG stream persists across `sov` process resume. CLI `sov anchor` dual-index heal matches the daemon.
