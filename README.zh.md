...
打印[完整的纸质游戏套装](assets/print/pdf/Sovereignty-Print-Pack.pdf)，包括棋盘、玩家垫板、快速参考指南、市场板和三副卡牌，共13张美国信纸大小的纸。找一个骰子和一些硬币。和两三个朋友坐在一起。你们可以在二十分钟内开始游戏。
...
- **[事件卡牌](assets/print/pdf/events.pdf)**——28张卡牌，四页，沿着线切割。
- **[交易卡牌](assets/print/pdf/deals.pdf)**——12张卡牌，两页。
- **[凭证卡牌](assets/print/pdf/vouchers.pdf)**——玩家之间的10个IOU（欠条），两页。
- **[市场板](assets/print/pdf/market.pdf)**——集市日 / 市政厅，一页。
...
**28 张事件卡**就像一个个小故事：“有人见过一个小皮包吗？”（丢失的钱包）或者“没人看到……对吧？”（发现捷径）。包含适用于市政厅游戏的市场变化事件。

**12 张交易卡 + 10 张凭证卡**促使玩家进行交流：“借我 2 枚硬币好吗？我会还 3 枚。”或者“如果你需要帮助，我也会支持你。”交易设定具有截止日期的目标；凭证是您发给其他玩家的欠条。
